...
int estado1;                       //variable utilizada para el estado del sensor1
int estado2;                       //variable utilizada para el estado del sensor2
...
void loop(){ //*************************************************
  ...
  estado1 = digitalRead(sensor1);   //lee el valor del sensor y lo guarda en "estado"
  
  if(estado1 == HIGH){             //si hay movimiento
  detecta();
  }else{
